...
# mapping script
if [[ $SPEC = "human" ]]; then
    sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/GRCm39_GENCODE/GRCh38.p13_GENCODE/" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/0_mapping_T7_SB.sh > 00.mapping/s0_mapping_T7_${SB}.sh
elif [[ $SPEC = "wheet" ]]; then
    sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/GRCm39_GENCODE/IWGSC_RefSeq_v2.1/" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/0_mapping_T7_SB.sh > 00.mapping/s0_mapping_T7_${SB}.sh
elif [[ $SPEC = "axolotl" ]]; then
    sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/GRCm39_GENCODE/axolotl_v6.0_sz/" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/0_mapping_T7_SB.sh > 00.mapping/s0_mapping_T7_${SB}.sh
else
    sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/0_mapping_T7_SB.sh > 00.mapping/s0_mapping_T7_${SB}.sh
fi

# bcPara files
sed "s/EXAMPLE-SN/${SN}/g; s/EXAMPLE-FC/${FC}/g; s/EXAMPLE-OUT/${OUTDIR}/g; s/EXAMPLE-FQ/${FQDIR}/g; s/EXAMPLE-SB/${SB}/g" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/T7_SB.bcPara > 00.mapping/L01_${SB}.bcPara 
...
if [[ $SPEC = "human" ]]; then
    ...
    sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/GRCm39_GENCODE/axolotl_v6.0_sz/; s/gencode.vM30.primary_assembly.annotation.gtf/AmexT_v47.gtf/" /mgi_storage/sk/luzhigang1/scripts/saw_v5.1_singularity/2_count_T7.sh > 02.count/s2_count_T7.sh
else
