...
# bcPara files
sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/EXAMPLE-FQ/${FQDIR}/" ../G400.bcPara > 00.mapping/L01.bcPara 
sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/EXAMPLE-FQ/${FQDIR}/; s/L01/L02/" ../G400.bcPara > 00.mapping/L02.bcPara 
sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/EXAMPLE-FQ/${FQDIR}/; s/L01/L03/" ../G400.bcPara > 00.mapping/L03.bcPara 
sed "s/EXAMPLE-SN/${SN}/; s/EXAMPLE-FC/${FC}/; s/EXAMPLE-OUT/${OUTDIR}/; s/EXAMPLE-FQ/${FQDIR}/; s/L01/L04/" ../G400.bcPara > 00.mapping/L04.bcPara 
